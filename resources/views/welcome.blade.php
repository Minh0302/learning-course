...
<head>
    ...
    <!--====== Title ======-->
    <title>Website Luyện thi tốt nghiệp THPT</title>
...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <!-- <li class="nav-item">
                                        <a href="{{url('su-kien')}}">Sự kiện</a>
                                    </li> -->
                                    <li class="nav-item">
                                        <a href="{{url('giao-vien')}}">Giáo viên</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <div class="search-box">
        <div class="serach-form">
            ...
            <form action="{{url('tim-kiem')}}" >
                <input type="text" placeholder="Search by keyword" id="keywords" name="tukhoa">
    ...
    {!! Toastr::message() !!}
    <script>
        $("#check-exam").on("submit", function(e){
            count = $('input:radio:checked').length;
            all_radio = $('input:radio').length/4;
            if(count != all_radio){
                $('#submit-exam').attr("type", "button");
                alert("Vui lòng chọn hết câu trả lời");
                e.preventDefault();
            }
            $('#submit-exam').attr("type", "submit");
        })
    </script>
</body>
