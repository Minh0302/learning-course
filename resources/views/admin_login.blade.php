              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Nhập email và password để đăng nhập</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="post" action="{{url('admin-dashboard')}}">
                  @csrf
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Email</label>
                      <div class="input-group has-validation">
                        <input type="email" name="admin_email" class="form-control" id="yourUsername" required>
