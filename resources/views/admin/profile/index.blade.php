                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <h5 class="card-title">Mục tiêu nghề nghiệp</h5>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <form method="post" action="{{url('/update-profile')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <label for="achievements" class="col-md-4 col-lg-3 col-form-label">Thành tựu</label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="objectives" class="col-md-4 col-lg-3 col-form-label">Mục tiêu nghề nghiệp</label>
                                        <div class="col-md-8 col-lg-9">
